...
from toll_booth.obj.graph.gql_scalars.object_properties import LocalPropertyValue, SensitivePropertyValue, \
    StoredPropertyValue
from toll_booth.obj.graph.gql_scalars.base import GraphScalar
